...
Essas regras simples são o bastante para que o modelo de \citeonline{akoglu2009rtg} tenha como emergentes algumas das propriedades desejáveis em um modelo de geração de redes complexas para.
